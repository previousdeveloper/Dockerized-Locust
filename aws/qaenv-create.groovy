node {
    ...
    sh """
        /usr/bin/ansible-playbook --private-key ~/.ssh/test_machine.pem" "${home}/ansible/locust-ec2.yaml"
    """
    stage "install locust"
    sh """
        /usr/bin/ansible-playbook --private-key ~/.ssh/test_machine.pem" "${home}/ansible/locust-inst.yaml"
    """    
    }
    catch (err) {
        throw err
